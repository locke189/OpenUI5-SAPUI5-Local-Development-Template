 ...
 */
function commit(sh, repoPath, message, options, done) <span class="missing-if-branch" title="if path not taken" >I</span>{
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    operatingSystemNormalizedMessage = escapedMessage.split(/\r?\n/);</span>
  } else {
...
&nbsp;
    ...
    .on('data',function(data) {
      ...
      /* istanbul ignore if  */
      <span class="skip-if-branch" title="if path not taken" >I</span>if(!options.quiet) {
<span class="cstat-skip" title="statement not covered" ></span>        if(isString(data))
        {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Apr 25 2016 01:51:30 GMT+0000 (UTC)
</div>
</div>
