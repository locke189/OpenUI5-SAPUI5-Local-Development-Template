...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ext === '.js' || ext === '.json') {
            content = JSON.parse(fs.readFileSync(configPath, 'utf8'));
        } else {
<span class="cstat-no" title="statement not covered" >            content = JSON.parse(</span>
                stripJSONComments(
